...
/client/proc/get_adminhelp()
	...
	switch(choice)
		if ("Admin Help")
			var/msg = tgui_input_text(src, "Please describe your problem concisely and an admin will help as soon as they're able.", "Adminhelp contents", multiline = TRUE, prevent_enter = TRUE, max_length = MAX_MESSAGE_LEN)
			adminhelp(msg)
		if ("Mentor Help")
			mentorhelp()
	// OV Edit End
